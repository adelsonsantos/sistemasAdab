...
/**
 * PortalComputadorSearch represents the model behind the search form about `app\models\PortalComputador`.
 */
class PortalComputadorSearch extends PortalComputador
{
    /**
     * @inheritdoc
     */
