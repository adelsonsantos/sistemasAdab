...
class TermoVigilanciaFiscalizacaoFaixaEtariaSearch extends TermoVigilanciaFiscalizacaoFaixaEtaria
{
    ...
    {
        return [
            [['vigilancia_fiscalizacao_faixa_etaria_id', 'vigilancia_fiscalizacao_animal_id'], 'integer'],
            [['vigilancia_fiscalizacao_faixa_etaria_periodo'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'vigilancia_fiscalizacao_faixa_etaria_periodo', $this->vigilancia_fiscalizacao_faixa_etaria_periodo]);
