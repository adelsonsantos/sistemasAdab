...
class DadosUnicoFuncionario extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'funcionario_dt_demissao' => 'Funcionario Dt Demissao',
            'funcionario_orgao_origem' => 'Funcionario Orgao Origem',
            'funcionario_conta_fgts' => 'Funcionario Conta Fgts',
            'contrato_id' => 'Contrato ID',
            'funcionario_salario' => 'Funcionario Salario',
            'cargo_temporario' => 'Cargo Temporario',
            'funcionario_orgao_destino' => 'Funcionario Orgao Destino',
