...
class TermoVigilanciaFiscalizacaoPopulacaoAnimal extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['vigilancia_fiscalizacao_faixa_etaria_id'], 'exist', 'skipOnError' => true, 'targetClass' => TermoVigilanciaFiscalizacaoFaixaEtaria::className(), 'targetAttribute' => ['vigilancia_fiscalizacao_faixa_etaria_id' => 'vigilancia_fiscalizacao_animal_faixa_etaria_id']],
        ];
    }
