        ...
        <table class="diaria">
            <tr class="bordaMenu">
                <th class="borda">
                    ...
                    Ação da Vigilância e Fiscalização
                </th>
            </tr>
            <td>
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_acao_st')->dropDownList(
                            [1 => 'Ativo', 2 => 'Inativo']); ?>
                    </div>
                    <div class="col-lg-2">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_acao_cmp_complentar')->dropDownList(
                            [1 => 'Sim', 2 => 'Não']); ?>
                    </div>
                </div>
