...
<div style="height:75px;">
    <div>
        ...
        <p class="font-topo" style="text-align: center">
            <?=Html::a('Cadastrar Entrada <span class="glyphicon glyphicon-plus" style="color: white; font-size: 1.2em; margin-left: 3%"></span>', ['/portal-equipamento/create'], ['class'=>'btn btn-success', 'title' => 'Cadastrar Contato']); ?>
            <br>
            <?= "";  ?>
        </p>
    </div>
