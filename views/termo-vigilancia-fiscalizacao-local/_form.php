...
<div style="height:95px;">
    <div>
        <h1 class="font-topo" style="text-align: center"><?= $model->isNewRecord ? 'Cadastrar' : 'Alterar' ?> local</h1>
    </div>
</div>
<div class="grid">
        ...
        <table class="diaria">
            <tr class="bordaMenu">
                <th class="borda">
                    ...
                    Local da Vigilância e Fiscalização
                </th>
            </tr>
            <td>
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_local_st')->dropDownList(
