        ...
        <table class="diaria">
            ...
            <table class="diaria">
                ...
                <table class="diaria">
                    ...
                    <tr>
                        <td class="borda"><?php// implode(ArrayHelper::map(DiariaMeioTransporte::find()->asArray()->where(['meio_transporte_id' => $model->meio_transporte_id])->all(), 'meio_transporte_ds', 'meio_transporte_ds'), ['class' => 'form-control col-sm-1']) ?>
                        </td>
                ...
                <table class="diaria">
                    ...
                    <tr>
                        ...
                        <td class="borda"><? //implode(ArrayHelper::map(Motivo::find()->asArray()->where(['motivo_id' => $sub_motivo_id])->all(), 'motivo_ds', 'motivo_ds'), ['class' => 'form-control col-sm-1']) ?>
                        </td>
