...
<div style="height:75px;">
    <div>
        ...
        <h1 class="font-topo" style="text-align: center">Comprovações para Aprovação <?=Html::submitButton('<span class="glyphicon glyphicon-open" style="color: green; font-size: 1.2em; margin-left: 3%"></span>', ['class' => 'btn btn-default',
    ...
    <?= GridView::widget([
        ...
        /*    ['class' => 'yii\grid\CheckboxColumn',  'checkboxOptions' => function($model) {
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'template' => '{view} {comprovacao_aprovacao_devolver} {comprovacao_aprovacao_aprovar}',
                'buttons' => [
                    ...
                    'comprovacao_aprovacao_devolver' => function ($model, $key) {
                        return Html::a('<span class="glyphicon glyphicon-save" style="color: red; font-size: 1.2em; margin-left: 3%"></span>', ['comprovacao-aprovacao-devolver', 'id' =>$key->diaria_id ],['title' => 'Devolver']);
                    },
                    'comprovacao_aprovacao_aprovar' => function ($model, $key) {
                        if(!is_null($key->diaria_empenho)){
                            return Html::a('<span class="glyphicon glyphicon-open" style="color: green; font-size: 1.2em; margin-left: 3%"></span>', ['comprovacao-aprovacao-aprovar', 'id' =>$key->diaria_id],[
                                'title' => 'Aprovar Comprovação',
                                'data' => [
                                    'confirm' => 'Tem certeza que deseja APROVAR a COMPROVAÇÃO??',
                                    'method'  => 'post',
                                ]
                            ]);
                        }
