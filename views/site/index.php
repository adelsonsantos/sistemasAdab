...
<head>
    <style>
        ...
        .dividaativa {
            background: url('<?=Yii::$app->request->baseUrl . "../../image/dividaAtiva.png"?>');
            background-size: 160px 190px;
            height: 190px;
            width: 160px;
            cursor: pointer;
        ...
        .dividaativa:hover {
            background: url('<?=Yii::$app->request->baseUrl . "../../image/dividaAtivaHover.png"?>');
            background-size: 160px 190px;
            height: 190px;
            width: 160px;
            cursor: pointer;
...
<table width="100%">
    <tr>
        ...
        <th>
            <?php echo Html::a('<div class="dividaativa"></div>', ['dividaativa-sefaz/index']) ?>
        </th>
