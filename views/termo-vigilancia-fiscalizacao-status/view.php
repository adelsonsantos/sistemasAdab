<div class="margin-top-menu">
    ...
    <div class="diarias-view" style="margin-left: 209px; margin-top: 44px; ">
        <table class="diaria">
            ...
            <tr>
                <td class="borda"><?= $model->vigilancia_fiscalizacao_status_id; ?></td>
                <td class="borda"><?= $model->vigilancia_fiscalizacao_status_nome; ?></td>
                <td class="borda"><?= $model->vigilancia_fiscalizacao_status_st == 1 ? "Ativo" : "Inativo"; ?></td>
                <td class="borda">
                    <table style=" width: 100%">
                        <tr>
                            <th style="text-align: center; width: 33%">
                                <?= Html::a('', ['update', 'id' => $model->vigilancia_fiscalizacao_status_id], ['class' => 'glyphicon glyphicon-pencil', 'title' => 'Alterar']) ?>
                            </th>
                            <th style="text-align: center; width: 33%">
                                <?= Html::a('', ['delete', 'id' => $model->vigilancia_fiscalizacao_status_id], [
                                    'class' => 'glyphicon glyphicon-remove', 'title' => 'Deletar',
                                    'data' => [
                                        'confirm' => 'Tem certeza de que deseja excluir este status?',
                                        'method' => 'post',
                                    ],
                                ]) ?>
                            </th>
