...
$this->title = 'Atividade da Vigilância e Fiscalizacao';
...
<div style="height:75px;">
    <div>
        <h1 class="font-topo" style="text-align: center">Atividade da Vigilância e Fiscalização </h1>
        <p class="font-topo" style="text-align: center">
            <?=Html::a('Cadastrar Atividade <span class="glyphicon glyphicon-plus" style="color: white; font-size: 1.2em; margin-left: 3%"></span>', ['/termo-vigilancia-fiscalizacao-atividade/create'], ['class'=>'btn btn-success', 'title' => 'Cadastrar Atividade']); ?>
            <br>
            <?= "";  ?>
        </p>
    </div>
