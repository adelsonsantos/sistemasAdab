        ...
        <table class="diaria">
            <tr class="bordaMenu">
                <th class="borda">
                    ...
                    Proprietário da Vigilância e Fiscalização
                </th>
            </tr>
            <td>
                <div class="row">
                    <div class="col-lg-3">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_proprietario_nome')->textInput(['maxlength' => true]) ?>
                    </div>
                    <div class="col-lg-2">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_proprietario_tipo_id')->dropDownList(
                            [1 => 'CPF', 2 => 'CNPJ'],
                            [
                                'onchange' => '                                
                                if(this.value == 1){
                                    ...
                                    document.getElementById("termovigilanciafiscalizacaoproprietario-vigilancia_fiscalizacao_proprietario_cpf").value = null;                                    
                                }else{
                                    document.getElementById("field-cpf").style.display = "none";
                                    document.getElementById("field-cnpj").style.display = "block";
                                    document.getElementById("termovigilanciafiscalizacaoproprietario-vigilancia_fiscalizacao_proprietario_cnpj").value = null;
                                }
                                '
                            ]
                        ); ?>
                    ...
                    <div class="col-lg-2" id="field-cpf">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_proprietario_cpf')->widget(MaskedInput::className(), [
                            'mask' => '999.999.999-99',
                        ]); ?>
                    </div>
                    <div class="col-lg-2" id="field-cnpj">
                        <?= $form->field($model, 'vigilancia_fiscalizacao_proprietario_cnpj')->widget(MaskedInput::className(), [
